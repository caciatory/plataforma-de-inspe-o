  ...
  return (
    <main className={`relatorio-page ${dmSans.className}`}>
      ...
      <section className="relatorio-hero">
        <HeroCarousel fotos={dados.fotosCapa} />
            ...
            <div className="relatorio-hero__dashboard glass">
              <div className="relatorio-hero__metric">
                ...
                <div>
                  ...
                  {dados.codigoCertificado && (
                    <div className="relatorio-hero__codigo">
                      Certificado{" "}
                      <span className="relatorio-hero__codigo-valor">{dados.codigoCertificado}</span>
              ...
              {dados.parceiroNome && (
                <>
                  ...
                  <div className="relatorio-hero__parceiro">
                    {dados.parceiroLogoUrl && (
                      // eslint-disable-next-line @next/next/no-img-element
                      <img
                        src={dados.parceiroLogoUrl}
                        alt={dados.parceiroNome}
                        className="relatorio-parceiro__logo"
                      />
                    )}
                    <div>
                      <p className="relatorio-eyebrow">Parceiro</p>
                      <p className="relatorio-hero__metric-value">{dados.parceiroNome}</p>
                      {dados.parceiroTelefone && (
                        <a
                          href={`https://wa.me/${dados.parceiroTelefone.replace(/\D/g, "")}`}
      ...
      <AnaliseTecnica
        ...
        opcoes={dados.opcoes}
        medicaoResultados={dados.medicaoResultados}
        photos={dados.photos}
      />

      <OutrosEquipamentos equipamentos={dados.equipamentos} fotos={dados.equipamentoFotos} />
          ...
          <div className="relatorio-veredito__grid">
            <div>
              ...
              <div className="relatorio-veredito__assinatura-row">
                ...
                <div>
                  <p className="relatorio-veredito__assinatura-nome">{dados.tecnicoNome}</p>
                  {dados.tecnicoCredencial && (
                    <p className="relatorio-veredito__assinatura-cargo">{dados.tecnicoCredencial}</p>
                  )}
                </div>
              </div>
              {dados.codigoCertificado && (
                ...
                <div className="relatorio-veredito__codigo">
                  ...
                  <span className="relatorio-veredito__codigo-valor">{dados.codigoCertificado}</span>
                  <CertificadoInfoButton />
                </div>
              )}
            </div>
      ...
      <footer className="relatorio-footer">
        <p>
          Técnico responsável: {dados.tecnicoNome}
          {dados.tecnicoCredencial ? ` (${dados.tecnicoCredencial})` : ""}
        </p>
        {dados.codigoCertificado && (
          <p>
            Certificado {dados.codigoCertificado}
            {dados.certificadoEmitidoEm &&
